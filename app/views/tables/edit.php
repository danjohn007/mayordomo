                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body p-2">
                                        <form method="POST" action="<?= BASE_URL ?>/tables/setPrimaryImage/<?= $img['id'] ?>">
                                        ...
                                        <form method="POST" action="<?= BASE_URL ?>/tables/deleteImage/<?= $img['id'] ?>" onsubmit="return confirm('¿Eliminar esta imagen?')">
