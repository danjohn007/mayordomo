...
class RoomsController extends BaseController {
    ...
    public function store() {
        ...
        $data = [
            ...
            'price_wednesday' => floatval($_POST['price_wednesday'] ?? $_POST['price'] ?? 0),
            'price_thursday' => floatval($_POST['price_thursday'] ?? $_POST['price'] ?? 0),
            'price_friday' => floatval($_POST['price_friday'] ?? $_POST['price'] ?? 0),
            'price_saturday' => floatval($_POST['price_saturday'] ?? $_POST['price'] ?? 0),
            'price_sunday' => floatval($_POST['price_sunday'] ?? $_POST['price'] ?? 0),
